...
public class ReservationInformationController {
    ...
    public BookingResponse sendReservationInformation(@RequestBody final PushNotificationRequest pushNotificationRequest) {
        return reservationInformationService.getReservationInformation(pushNotificationRequest);
    }
}
